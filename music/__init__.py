...
def create_app():
    ...
    #     # Use Jinja to customize a predefined html page rendering the layout for showing a single tracks.
    #     return render_template('simple_track.html', track=some_track)
    with app.app_context():
        from .home import routes
        from .tracks import routes

        app.register_blueprint(home.blueprint_home)
        app.register_blueprint(tracks.blueprint_track)
